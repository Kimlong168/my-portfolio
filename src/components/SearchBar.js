      ...
      <div className="mx-auto max-w-md">
        ...
        >
          <input
            ...
            className="peer cursor-pointer relative z-10 h-12 w-12 rounded-full border bg-transparent pl-12 outline-none focus:w-full focus:cursor-text focus:border-blue-300 focus:pl-16 focus:pr-4 text-white"
          />
          <svg
